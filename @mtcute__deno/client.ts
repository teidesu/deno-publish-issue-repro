...
import { downloadToFile } from "./methods/download-file.ts";
import { DenoPlatform } from "./platform.ts";
import { SqliteStorage } from "./sqlite/index.ts";
import { DenoCryptoProvider } from "./utils/crypto.ts";
import { TcpTransport } from "./utils/tcp.ts";
...
export class TelegramClient extends TelegramClientBase {
    ...
    override downloadToFile(filename: string, location: FileDownloadLocation, params?: FileDownloadParameters | undefined): Promise<void> {

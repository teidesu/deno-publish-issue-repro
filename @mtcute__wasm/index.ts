import type { MtcuteWasmModule, SyncInitInput } from "./types.ts";
export * from "./types.ts";
export const SIMD_AVAILABLE: boolean = /* @__PURE__ */ WebAssembly.validate(new Uint8Array([0, 97, 115, 109, 1, 0, 0, 0, 1, 5, 1, 96, 0, 1, 123, 3, 2, 1, 0, 10, 10, 1, 8, 0, 65, 0, 253, 15, 253, 98, 11]));
...
export function gunzip(bytes: Uint8Array): Uint8Array {
    ...
    if (ret === -3)
        throw new Error('gunzip error -- short input'); // should never happen

import type { I18nStrings, I18nValue, MtcuteI18nAdapter, MtcuteI18nFunction, OtherLanguageWrap } from "./types.ts";
import { createI18nStringsIndex, extractLanguageFromUpdate } from "./utils.ts";
export * from "./plurals/english.ts";
export * from "./plurals/russian.ts";
export * from "./types.ts";
export { extractLanguageFromUpdate } from "./utils.ts";
...
export function createMtcuteI18n<Strings extends I18nStrings, Input>(params: MtcuteI18nParameters<Strings, Input>): MtcuteI18nFunction<Strings, Input> {
    const { primaryLanguage, otherLanguages, defaultLanguage = primaryLanguage.name, adapter = extractLanguageFromUpdate as unknown as MtcuteI18nAdapter<Input>, } = params;

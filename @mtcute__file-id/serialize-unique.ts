...
import { assertNever, telegramRleEncode } from "./utils.ts";
...
export function toUniqueFileId(first: td.FileType | Omit<td.RawFullRemoteFileLocation, '_'>, second?: InputUniqueLocation): string {

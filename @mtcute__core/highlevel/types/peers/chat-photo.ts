...
import { strippedPhotoToJpg } from "../../utils/file-utils.ts";
import { makeInspectable } from "../../utils/index.ts";
import { memoizeGetters } from "../../utils/memoize.ts";
import { FileLocation } from "../files/index.ts";
/**
 * A size of a chat photo
 */
export class ChatPhotoSize extends FileLocation {
    constructor(readonly peer: tl.TypeInputPeer, readonly obj: tl.RawUserProfilePhoto | tl.RawChatPhoto, readonly big: boolean) {
        super({
...
export class ChatPhoto {
    constructor(readonly peer: tl.TypeInputPeer, readonly raw: tl.RawUserProfilePhoto | tl.RawChatPhoto) { }
    /**

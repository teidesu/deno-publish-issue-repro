...
export class User {
    ...
    get photo(): ChatPhoto | null {
        if (this.raw.photo?._ !== 'userProfilePhoto')
            return null;
    ...
    get color(): ChatColors {
        return new ChatColors(this.raw.id, this.raw.color?._ === 'peerColor' ? this.raw.color : undefined);
    }
    /**
    ...
    get profileColors(): ChatColors | null {
        return this.raw.profileColor
            ? new ChatColors(this.raw.id, this.raw.profileColor?._ === 'peerColor' ? this.raw.profileColor : undefined)
            : null;
    }

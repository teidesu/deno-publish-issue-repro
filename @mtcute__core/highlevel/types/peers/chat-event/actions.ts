...
import { ChatMember } from "../chat-member.ts";
import { ChatPermissions } from "../chat-permissions.ts";
import { ForumTopic } from "../forum-topic.ts";
...
/** @internal */
export function _actionFromTl(e: tl.TypeChannelAdminLogEventAction, peers: PeersIndex, peerId: number): ChatAction {
    switch (e._) {
        ...
        case 'channelAdminLogEventActionChangeProfilePeerColor':
            ...
            if (e.prevValue._ !== 'peerColor' || e.newValue._ !== 'peerColor')
                return null;
            return {

...
import { BusinessAccount } from "../premium/business-account.ts";
...
export class FullUser extends User {
    ...
    get personalPhoto(): Photo | null {
        if (!this.full || this.full._ !== 'userFull')
            return null;
        if (this.full.personalPhoto?._ !== 'photo')
            return null;
    ...
    get publicPhoto(): Photo | null {
        if (!this.full || this.full._ !== 'userFull')
            return null;
        if (this.full.fallbackPhoto?._ !== 'photo')
            return null;
    ...
    get personalChannel(): Chat | null {
        if (this.full.personalChannelId == null)
            return null;
    ...
    get business(): BusinessAccount | null {
        if (this.full.businessWorkHours != null
    ...
    get starsRatingPending(): {
        ...
        if (!this.full.starsMyPendingRating)
            return null;
        return {
    ...
    get lastSavedMusic(): Audio | null {
        if (this.full.savedMusic?._ !== 'document')
            return null;

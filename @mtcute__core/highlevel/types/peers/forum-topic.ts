...
import { MtMessageNotFoundError } from "../errors.ts";
import { DraftMessage, Message } from "../messages/index.ts";
...
export class ForumTopic {
    ...
    constructor(readonly raw: tl.RawForumTopic, readonly _peers: PeersIndex, readonly _messages?: Map<number, tl.TypeMessage> | undefined) { }

...
import { toReactionEmoji } from "./types.ts";
/**
 * Reactions of a user to a message
 */
export class PeerReaction {
    constructor(readonly raw: tl.RawMessagePeerReaction, readonly _peers: PeersIndex) { }
    /**
...
export class PaidPeerReaction {
    constructor(readonly raw: tl.RawMessageReactor, readonly _peers: PeersIndex) { }

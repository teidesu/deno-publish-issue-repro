...
export class TodoItem {
    constructor(readonly raw: tl.TypeTodoItem, readonly _peers: PeersIndex, readonly completion: tl.RawTodoCompletion | undefined) { }
    get id(): number {
        return this.raw.id;
    }
...
export class TodoList {
    ...
    constructor(readonly raw: tl.RawMessageMediaToDo, readonly _peers: PeersIndex) { }

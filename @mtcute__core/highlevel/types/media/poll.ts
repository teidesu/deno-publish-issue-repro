...
export class PollAnswer {
    constructor(readonly raw: tl.TypePollAnswer, readonly result?: tl.RawPollAnswerVoters | undefined) { }
    /**
     * Answer text
     */
    get text(): string {
...
export class Poll {
    ...
    constructor(readonly raw: tl.TypePoll, readonly _peers: PeersIndex, readonly results?: tl.RawPollResults | undefined) { }
    /**

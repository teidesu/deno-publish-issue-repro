...
import { inflateSvgPath, strippedPhotoToJpg, svgPathToFile } from "../../utils/file-utils.ts";
...
export class Thumbnail extends FileLocation {
     ...
     */
    get fileId(): string {
        if ((this.raw._ !== 'photoSize' && this.raw._ !== 'photoSizeProgressive' && this.raw._ !== 'videoSize')

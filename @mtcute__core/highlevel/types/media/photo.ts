...
export class Photo extends FileLocation {
    ...
    constructor(readonly raw: tl.RawPhoto, readonly media?: tl.RawMessageMediaPhoto | undefined) {
        const location = {
    ...
    get isMarkupAvatar(): boolean {
        return Boolean(this.raw.videoSizes?.some(s => s._ === 'videoSizeEmojiMarkup' || s._ === 'videoSizeStickerMarkup'));
    }

 ...
 * @param params  Additional parameters
 */
export function geo(latitude: number, longitude: number, params: OmitTypeAndFile<InputMediaGeo, 'latitude' | 'longitude'> = {}): InputMediaGeo {
 ...
 * @param params  Additional parameters
 */
export function geoLive(latitude: number, longitude: number, params: OmitTypeAndFile<InputMediaGeoLive, 'latitude' | 'longitude'> = {}): InputMediaGeoLive {

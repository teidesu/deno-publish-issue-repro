...
import type { InputPeerLike, Peer } from "../peers/peer.ts";
...
export class StarGift {
    constructor(readonly raw: tl.RawStarGift, readonly _peers: PeersIndex) { }
    /** ID of the gift */
    get id(): tl.Long {
        return this.raw.id;
    }
    ...
    get action(): {
        ...
        if (!this.raw.auctionSlug || this.raw.giftsPerRound == null)
            return null;
        return {

...
import type { MessageMedia } from "../messages/message-media.ts";
import type { Peer } from "../peers/peer.ts";
import type { PeersIndex } from "../peers/peers-index.ts";
import type { User } from "../peers/user.ts";
import { makeInspectable } from "../../utils/inspectable.ts";
import { memoizeGetters } from "../../utils/memoize.ts";
import { WebDocument } from "../files/web-document.ts";
import { _messageMediaFromTl } from "../messages/message-media.ts";
import { parsePeer } from "../peers/peer.ts";
import { StarGiftUnique } from "./star-gift-unique.ts";
import { StarGift } from "./star-gift.ts";
...
export class StarsTransaction {
    constructor(readonly raw: tl.RawStarsTransaction, readonly peers: PeersIndex) { }

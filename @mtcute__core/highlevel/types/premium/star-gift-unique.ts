...
export class StarGiftUniqueAttribute {
    constructor(readonly raw: tl.RawStarGiftAttributeModel | tl.RawStarGiftAttributePattern) { }
...
export class StarGiftUniqueBackdrop {
    constructor(readonly raw: tl.RawStarGiftAttributeBackdrop) { }
    /** ID of the backdrop */
    get id(): number {
...
export class StarGiftUniqueOriginalDetails {
    constructor(readonly raw: tl.RawStarGiftAttributeOriginalDetails, readonly _peers: PeersIndex) { }
    /**
    ...
    get sender(): Peer | null {
        if (!this.raw.senderId)
            return null;
        if (!this._peers.has(this.raw.senderId))
            return null;
    ...
    get recipient(): Peer | null {
        if (!this._peers.has(this.raw.recipientId))
            return null;
...
export class StarGiftUnique {
    ...
    constructor(readonly raw: tl.RawStarGiftUnique, readonly _peers: PeersIndex) {
    ...
    get owner(): Peer | null {
        if (!this.raw.ownerId)
            return null;
        if (!this._peers.has(this.raw.ownerId))
            return null;
    ...
    get peerColor(): tl.RawPeerColorCollectible | null {
        if (this.raw.peerColor?._ !== 'peerColorCollectible')
            return null;
    ...
    get host(): Peer | null {
        if (!this.raw.hostId)
            return null;
        if (!this._peers.has(this.raw.hostId))
            return null;

import type { InputFileLike } from "../files/index.ts";
import type { MaskPosition, Sticker, StickerType } from "../media/index.ts";
...
import { MtEmptyError } from "../errors.ts";
import { parseSticker } from "../media/document-utils.ts";
import { Thumbnail } from "../media/index.ts";
/**
 * Input sticker set.
 * Can be one of:
 *   - Raw TL object

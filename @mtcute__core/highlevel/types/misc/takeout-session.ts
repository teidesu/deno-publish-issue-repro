...
export class TakeoutSession {
     ...
     */
    readonly id: tl.Long;
    constructor(readonly client: ITelegramClient, session: tl.account.RawTakeout) {
        this.id = session.id;
    }
    /**
     ...
     */
    async call<T extends tl.RpcMethod>(message: MustEqual<T, tl.RpcMethod>, params?: RpcCallOptions & {

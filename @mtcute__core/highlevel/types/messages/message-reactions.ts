...
import { PaidPeerReaction, PeerReaction } from "../reactions/peer-reaction.ts";
import { ReactionCount } from "../reactions/reaction-count.ts";
/**
 * Reactions on a message
 */
export class MessageReactions {
    constructor(readonly messageId: number, readonly chatId: number, readonly raw: tl.RawMessageReactions, readonly _peers: PeersIndex) { }
    /**

...
import type { Peer, PeerSender } from "../peers/peer.ts";
...
export class RepliedMessageInfo {
    constructor(readonly raw: tl.RawMessageReplyHeader, readonly _peers: PeersIndex) { }

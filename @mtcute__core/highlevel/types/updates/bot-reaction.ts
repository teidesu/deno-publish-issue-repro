...
import type { InputReaction } from "../reactions/types.ts";
...
import { ReactionCount } from "../reactions/reaction-count.ts";
import { toReactionEmoji } from "../reactions/types.ts";
/**
...
export class BotReactionUpdate {
    constructor(readonly raw: tl.RawUpdateBotMessageReaction, readonly _peers: PeersIndex) { }
    /**
...
export class BotReactionCountUpdate {
    constructor(readonly raw: tl.RawUpdateBotMessageReactions, readonly _peers: PeersIndex) { }
    /**
     * Chat where the reaction has been changed
     */
    get chat(): Peer {

...
import { ChatInviteLink } from "../peers/chat-invite-link.ts";
import { ChatMember } from "../peers/chat-member.ts";
...
export class ChatMemberUpdate {
    constructor(readonly raw: tl.RawUpdateChatParticipant | tl.RawUpdateChannelParticipant, readonly _peers: PeersIndex) { }
    /**
     * Date of the event
     */
    get date(): Date {

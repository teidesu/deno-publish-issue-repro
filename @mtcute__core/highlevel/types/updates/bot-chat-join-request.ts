...
import { getBarePeerId, getMarkedPeerId } from "../../../utils/peer-utils.ts";
import { makeInspectable } from "../../utils/index.ts";
import { memoizeGetters } from "../../utils/memoize.ts";
import { Chat, ChatInviteLink, User } from "../peers/index.ts";
/**
...
export class BotChatJoinRequestUpdate {
    constructor(readonly raw: tl.RawUpdateBotChatInviteRequester, readonly _peers: PeersIndex) { }
    /**

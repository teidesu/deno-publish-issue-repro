...
import { encodeInlineMessageId } from "../../utils/inline-utils.ts";
...
class BaseCallbackQuery {
    constructor(readonly raw: tl.RawUpdateBotCallbackQuery | tl.RawUpdateInlineBotCallbackQuery | tl.RawUpdateBusinessBotCallbackQuery, readonly _peers: PeersIndex) { }
    /**
...
export class CallbackQuery extends BaseCallbackQuery {
    constructor(override readonly raw: tl.RawUpdateBotCallbackQuery, _peers: PeersIndex) {
        super(raw, _peers);
    }
    /**
...
export class InlineCallbackQuery extends BaseCallbackQuery {
    constructor(override readonly raw: tl.RawUpdateInlineBotCallbackQuery, _peers: PeersIndex) {
        super(raw, _peers);
    }
    /**
...
export class BusinessCallbackQuery extends BaseCallbackQuery {
    constructor(override readonly raw: tl.RawUpdateBusinessBotCallbackQuery, _peers: PeersIndex) {
        super(raw, _peers);
    }

...
import type { ReactionEmoji } from "../reactions/index.ts";
import type { StoryInteractiveElement } from "./interactive/index.ts";
import { MtUnsupportedError } from "../../../types/errors.ts";
...
import { toReactionEmoji } from "../reactions/index.ts";
import { _storyInteractiveElementFromTl } from "./interactive/index.ts";
import { StoryInteractions } from "./story-interactions.ts";
/**
...
export class Story {
    constructor(readonly raw: tl.RawStoryItem, readonly _peers: PeersIndex) { }
    ...
    get media(): StoryMedia {
        switch (this.raw.media._) {
            case 'messageMediaPhoto':
                if (this.raw.media.photo?._ !== 'photo')

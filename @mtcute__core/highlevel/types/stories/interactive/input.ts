...
import type { VenueSource } from "../../media/index.ts";
import type { InputReaction } from "../../reactions/index.ts";
import Long from 'long';
import { normalizeInputReaction } from "../../reactions/index.ts";
/**
...
export class StoryElement {
    ...
    reaction(reaction: InputReaction, params: {
        /**

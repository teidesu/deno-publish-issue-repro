...
import type { Peer } from "../peers/index.ts";
...
import { parsePeer, PeersIndex, User } from "../peers/index.ts";
...
export class StoryViewer {
    constructor(readonly raw: tl.RawStoryView, readonly _peers: PeersIndex) { }
...
export class StoryRepost {
    constructor(readonly raw: tl.RawStoryViewPublicForward | tl.RawStoryViewPublicRepost, readonly _peers: PeersIndex) { }

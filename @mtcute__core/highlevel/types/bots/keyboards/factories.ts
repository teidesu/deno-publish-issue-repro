import type { InlineKeyboardMarkup, ReplyKeyboardForceReply, ReplyKeyboardHide, ReplyKeyboardMarkup, ReplyMarkup, } from "./types.ts";
import { utf8 } from '@fuman/utils';
import { tl } from '@mtcute/tl';
import { assertNever } from "../../../../types/utils.ts";
import { toInputUser } from "../../../utils/peer-utils.ts";
import { BotKeyboardBuilder } from "./builder.ts";
 ...
 */
export function reply(buttons: tl.TypeKeyboardButton[][], params: Omit<ReplyKeyboardMarkup, 'type' | 'buttons'> = {}): ReplyKeyboardMarkup {
 ...
 */
export function callback(text: string, data: string | Uint8Array, requiresPassword?: boolean): tl.RawKeyboardButtonCallback {
    return {
 ...
 * @param params
 */
export function urlAuth(text: string, url: string, params: {
    /**
 ...
 */
export function requestPeer(text: string, buttonId: number, params: {
    /**
 ...
 */
export function findButton(buttons: tl.TypeKeyboardButton[][], predicate: string | ((btn: tl.TypeKeyboardButton) => boolean)): tl.TypeKeyboardButton | null {

...
import type { InputInlineResult, InputInlineResultArticle, InputInlineResultAudio, InputInlineResultContact, InputInlineResultFile, InputInlineResultGame, InputInlineResultGeo, InputInlineResultGif, InputInlineResultPhoto, InputInlineResultSticker, InputInlineResultVenue, InputInlineResultVideo, InputInlineResultVoice, } from "./types.ts";
import { MtArgumentError } from "../../../../types/errors.ts";
import { fileIdToInputDocument, fileIdToInputPhoto } from "../../../utils/convert-file-id.ts";
import { extractFileName } from "../../../utils/file-utils.ts";
import { BotInlineMessage } from "../inline-message/index.ts";
/**
 ...
 */
export function gif(id: string, media: string | tl.RawInputWebDocument | tl.RawInputDocument, params: Omit<InputInlineResultGif, 'type' | 'id' | 'media'> = {}): InputInlineResultGif {
 ...
 * @param params  Additional parameters
 */
export function video(id: string, media: string | tl.RawInputWebDocument | tl.RawInputDocument, params: Omit<InputInlineResultVideo, 'type' | 'id' | 'media'>): InputInlineResultVideo {
 ...
 * @param params  Additional parameters
 */
export function audio(id: string, media: string | tl.RawInputWebDocument | tl.RawInputDocument, params: Omit<InputInlineResultAudio, 'type' | 'id' | 'media'>): InputInlineResultAudio {
 ...
 * @param params  Additional parameters
 */
export function voice(id: string, media: string | tl.RawInputWebDocument | tl.RawInputDocument, params: Omit<InputInlineResultVoice, 'type' | 'id' | 'media'>): InputInlineResultVoice {
 ...
 * @param params  Additional parameters
 */
export function photo(id: string, media: string | tl.RawInputWebDocument | tl.RawInputPhoto, params: Omit<InputInlineResultPhoto, 'type' | 'id' | 'media'> = {}): InputInlineResultPhoto {
 ...
 * @param params  Additional parameters
 */
export function file(id: string, media: string | tl.RawInputWebDocument | tl.RawInputDocument, params: Omit<InputInlineResultFile, 'type' | 'id' | 'media'>): InputInlineResultFile {
 ...
 * @param params  Additional parameters
 */
export function game(id: string, shortName: string, params: Omit<InputInlineResultGame, 'type' | 'id' | 'shortName'> = {}): InputInlineResultGame {
...
/** @internal */
export async function _convertToTl(client: ITelegramClient, results: InputInlineResult[]): Promise<[
    boolean,
    tl.TypeInputBotInlineResult[]
]> {

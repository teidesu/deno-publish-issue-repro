import type { InputMediaContact, InputMediaGeo, InputMediaGeoLive, InputMediaVenue, InputMediaWebpage, } from "../../media/index.ts";
import type { InputText } from "../../misc/entities.ts";
import type { ReplyMarkup } from "../index.ts";
/**

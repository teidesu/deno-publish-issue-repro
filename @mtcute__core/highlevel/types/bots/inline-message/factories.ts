...
import type { InputMediaGeoLive } from "../../media/index.ts";
import type { InputInlineMessage, InputInlineMessageContact, InputInlineMessageGame, InputInlineMessageGeo, InputInlineMessageGeoLive, InputInlineMessageMedia, InputInlineMessageText, InputInlineMessageVenue, InputInlineMessageWebpage, } from "./types.ts";
import { assertNever } from "../../../../types/utils.ts";
import { _normalizeInputText } from "../../../methods/misc/normalize-text.ts";
import { BotKeyboard } from "../keyboards/index.ts";
/**
 ...
 * @param params
 */
export function text(text: InputText, params: Omit<InputInlineMessageText, 'type' | 'text'> = {}): InputInlineMessageText {
...
/** @internal */
export async function _convertToTl(client: ITelegramClient, obj: InputInlineMessage): Promise<tl.TypeInputBotInlineMessage> {
    switch (obj.type) {
        case 'text': {

...
import type { IKeyValueRepository } from "../../../storage/repository/key-value.ts";
...
import { MtArgumentError } from "../../../types/index.ts";
...
export class CurrentUserService extends BaseService {
    constructor(private _kv: IKeyValueRepository, opts: ServiceOptions) {
        super(opts);
    }

...
export class RefMessagesService extends BaseService {
    private _cache: LruMap<number, [
        number,
        number
    ]>;
    constructor(readonly options: RefMessagesServiceOptions, readonly _refs: IReferenceMessagesRepository, common: ServiceOptions) {
        super(common);
    ...
    async getForPeer(peerId: number): Promise<[
        number,
        number
    ] | null> {

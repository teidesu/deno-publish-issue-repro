...
import type { ConnectionKind, RpcCallOptions } from "../network/index.ts";
import type { ICorePlatform } from "../types/platform.ts";
import type { MustEqual, PublicPart } from "../types/utils.ts";
import type { Logger } from "../utils/logger.ts";
import type { AppConfigManager } from "./managers/app-config-manager.ts";
import type { TimersManager } from "./managers/timers.ts";
import type { TelegramStorageManager } from "./storage/storage.ts";

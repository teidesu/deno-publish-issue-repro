...
import type { ChatEvent, InputPeerLike } from "../../types/index.ts";
...
import { getChatEventLog } from "./get-chat-event-log.ts";
/**
 ...
 * @param params
 */
export async function* iterChatEventLog(client: ITelegramClient, chatId: InputPeerLike, params?: Parameters<typeof getChatEventLog>[2] & {
    /**

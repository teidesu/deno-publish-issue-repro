...
import type { ChatMember, InputPeerLike } from "../../types/index.ts";
import { isInputPeerChat } from "../../utils/peer-utils.ts";
import { resolvePeer } from "../users/resolve-peer.ts";
import { getChatMembers } from "./get-chat-members.ts";
/**
 ...
 */
export async function* iterChatMembers(client: ITelegramClient, chatId: InputPeerLike, params?: Parameters<typeof getChatMembers>[2] & {
    /**

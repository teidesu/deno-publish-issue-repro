...
import { makeArrayWithTotal } from "../../utils/misc-utils.ts";
 ...
 */
export async function getSimilarChannels(client: ITelegramClient, channel: InputPeerLike): Promise<ArrayWithTotal<Chat>> {

...
import type { InputChatEventFilters } from "../../types/peers/chat-event/filters.ts";
import Long from 'long';
import { getMarkedPeerId, toggleChannelIdMark } from "../../../utils/peer-utils.ts";
import { ChatEvent, PeersIndex } from "../../types/index.ts";
import { normalizeChatEventFilters } from "../../types/peers/chat-event/filters.ts";
 ...
 * @param params
 */
export async function getChatEventLog(client: ITelegramClient, chatId: InputPeerLike, params?: {
    /**
     * Search query
     */
    query?: string;

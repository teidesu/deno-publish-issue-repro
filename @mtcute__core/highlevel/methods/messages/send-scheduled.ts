 ...
 */
export async function sendScheduled(client: ITelegramClient, peer: InputPeerLike, ids: MaybeArray<number>): Promise<Message[]> {
    ...
    const msgs = res.updates
        .filter((u): u is Extract<typeof u, tl.RawUpdateNewMessage | tl.RawUpdateNewChannelMessage> => u._ === 'updateNewMessage' || u._ === 'updateNewChannelMessage')

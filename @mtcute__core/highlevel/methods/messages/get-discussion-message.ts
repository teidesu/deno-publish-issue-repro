...
import type { InputMessageId } from "../../types/messages/index.ts";
import type { InputPeerLike } from "../../types/peers/index.ts";
import { Message, normalizeInputMessageId } from "../../types/messages/index.ts";
import { PeersIndex } from "../../types/peers/index.ts";
import { resolvePeer } from "../users/resolve-peer.ts";
/** @internal */
export async function _getDiscussionMessage(client: ITelegramClient, peer: InputPeerLike, message: number): Promise<[
    tl.TypeInputPeer,
    number
]> {
 ...
 */
export async function getDiscussionMessage(client: ITelegramClient, params: InputMessageId): Promise<Message | null> {

...
import type { InputPeerLike, TypingStatus } from "../../types/index.ts";
 ...
 * @param params
 */
export async function sendTyping(client: ITelegramClient, chatId: InputPeerLike, status: Exclude<TypingStatus, 'interaction' | 'interaction_seen'> | tl.TypeSendMessageAction = 'typing', params?: {
    /**

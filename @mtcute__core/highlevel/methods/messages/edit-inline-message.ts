...
import type { InputMediaLike, InputText, ReplyMarkup } from "../../types/index.ts";
import { tl } from '@mtcute/tl';
import { BotKeyboard } from "../../types/index.ts";
 ...
 * @param params
 */
export async function editInlineMessage(client: ITelegramClient, params: {
    /**
     * Inline message ID, either as a TL object, or as a
     * TDLib and Bot API compatible string
     */

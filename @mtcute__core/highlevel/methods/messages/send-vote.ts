...
import { MtMessageNotFoundError, normalizeInputMessageId, PeersIndex, Poll } from "../../types/index.ts";
 ...
 */
export async function sendVote(client: ITelegramClient, params: InputMessageId & {
    /**

...
import type { InputMessageId, InputText, Message } from "../../types/index.ts";
import { assert } from '@fuman/utils';
import { inputTextToTl, normalizeInputMessageId } from "../../types/index.ts";
 ...
 */
export async function appendTodoList(client: ITelegramClient, params: InputMessageId & {
    /** Items to append */

...
import type { PeerReaction } from "../../types/index.ts";
import { normalizeInputMessageId, normalizeInputReaction } from "../../types/index.ts";
import { resolvePeer } from "../users/resolve-peer.ts";
import { getReactionUsers } from "./get-reaction-users.ts";
/**
 ...
 * @param params
 */
export async function* iterReactionUsers(client: ITelegramClient, params: Parameters<typeof getReactionUsers>[1] & {
    /**

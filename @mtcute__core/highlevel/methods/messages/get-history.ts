 ...
 */
export async function getHistory(client: ITelegramClient, chatId: InputPeerLike, params?: {
    /**
    ...
    if (!params)
        params = {};
    const { reverse = false, limit = 100, offset: { id: offsetId, date: offsetDate } = reverse ? defaultOffsetReverse : defaultOffset, addOffset = 0, minId = 0, maxId = 0, } = params;

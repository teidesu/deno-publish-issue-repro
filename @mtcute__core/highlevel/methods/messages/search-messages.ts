...
import { makeArrayPaginated, normalizeDate } from "../../utils/misc-utils.ts";
 ...
 */
export async function searchMessages(client: ITelegramClient, params?: {
    /**
    ...
    if (!params)
        params = {};
    const { query = '', chatId = { _: 'inputPeerEmpty' }, offset = 0, addOffset = 0, minId = 0, maxId = 0, threadId, limit = 100, filter = SearchFilters.Empty, } = params;

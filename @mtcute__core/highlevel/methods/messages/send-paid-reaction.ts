...
import { MessageReactions, normalizeInputMessageId, PeersIndex, } from "../../types/index.ts";
 ...
 */
export async function sendPaidReaction(client: ITelegramClient, params: InputMessageId & {
    /**

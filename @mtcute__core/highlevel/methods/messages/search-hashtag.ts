 ...
 */
export async function searchHashtag(client: ITelegramClient, hashtag: string, params?: {
 ...
 * @param params  Additional parameters
 */
export async function* iterSearchHashtag(client: ITelegramClient, hashtag: string, params?: Parameters<typeof searchHashtag>[2] & {
    /**

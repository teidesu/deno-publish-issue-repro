...
import type { ArrayPaginated, InputMessageId, InputReaction, } from "../../types/index.ts";
import { normalizeInputMessageId, normalizeInputReaction, PeerReaction, PeersIndex, } from "../../types/index.ts";
 ...
 * @param params
 */
export async function getReactionUsers(client: ITelegramClient, params: InputMessageId & {
    /**
    ...
    return makeArrayPaginated(res.reactions.map(it => new PeerReaction(it, peers)), res.count, res.nextOffset);
}

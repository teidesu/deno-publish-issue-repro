...
import type { InputMediaLike, InputMessageId, InputText, Message, ReplyMarkup, } from "../../types/index.ts";
import { BotKeyboard, normalizeInputMessageId, } from "../../types/index.ts";
 ...
 * @param params
 */
export async function editMessage(client: ITelegramClient, params: InputMessageId & {
    /**
     * New message text
     *

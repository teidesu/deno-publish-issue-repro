...
import type { InputPeerLike, InputText, Message, ReplyMarkup } from "../../types/index.ts";
...
import { MtMessageNotFoundError } from "../../types/index.ts";
 ...
 * it can't be copied.
 */
export async function sendCopy(client: ITelegramClient, params: SendCopyParams & ({
    /** Source chat ID */
    ...
    if (msg.media && msg.media.type !== 'webpage' && msg.media.type !== 'invoice') {
        ...
        return sendMedia(client, toChatId, {
            type: 'auto',

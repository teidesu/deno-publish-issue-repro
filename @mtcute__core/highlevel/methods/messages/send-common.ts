...
import type { TextWithEntities } from "../../types/misc/entities.ts";
...
import { MtMessageNotFoundError } from "../../types/errors.ts";
import { normalizeDate, normalizeMessageId } from "../../utils/index.ts";
import { _getPeerChainId } from "../misc/chain-id.ts";
...
import { _getTypingTimerId } from "./set-typing.ts";
// @exported
 ...
 * @noemit
 */
export function _normalizeQuickReplyShortcut(shortcut: number | string | undefined): tl.TypeInputQuickReplyShortcut | undefined {
    if (!shortcut)
        return undefined;
 ...
 * @noemit
 */
export async function _processCommonSendParameters(client: ITelegramClient, chatId: InputPeerLike, params: CommonSendParams): Promise<{

...
export function answerText(client: ITelegramClient, message: Message, ...params: ParametersSkip2<typeof sendText>): ReturnType<typeof sendText> {
...
export function answerMedia(client: ITelegramClient, message: Message, ...params: ParametersSkip2<typeof sendMedia>): ReturnType<typeof sendMedia> {
    if (!message.isTopicMessage || !message.replyToMessage?.threadId) {
...
export function answerMediaGroup(client: ITelegramClient, message: Message, ...params: ParametersSkip2<typeof sendMediaGroup>): ReturnType<typeof sendMediaGroup> {
    if (!message.isTopicMessage || !message.replyToMessage?.threadId) {

...
import { SearchFilters } from "../../types/index.ts";
 ...
 */
export async function* iterSearchMessages(client: ITelegramClient, params?: Parameters<typeof searchMessages>[1] & {
    /**
    ...
    if (!params)
        params = {};
    const { query = '', chatId = { _: 'inputPeerEmpty' }, minId = 0, maxId = 0, threadId, limit = Infinity, chunkSize = 100, filter = SearchFilters.Empty, } = params;

...
import { Message } from "../../types/messages/index.ts";
 ...
 * @noemit
 */
export function _findMessageInUpdate(client: ITelegramClient, res: tl.TypeUpdates, isEdit?: boolean, noDispatch?: boolean, allowNull?: false, randomId?: tl.Long): Message;
/**
 * @internal
 * @noemit
 */
export function _findMessageInUpdate(client: ITelegramClient, res: tl.TypeUpdates, isEdit?: boolean, noDispatch?: boolean, allowNull?: true, randomId?: tl.Long): Message | null;
/**
 * @internal
 * @noemit
 */
export function _findMessageInUpdate(client: ITelegramClient, res: tl.TypeUpdates, isEdit = false, noDispatch = true, allowNull = false, randomId?: tl.Long): Message | null {
    ...
    if (allowNull)
        return null;
    throw new MtTypeAssertionError('_findInUpdate (@ .updates[*])', 'updateNewMessage | updateNewChannelMessage | updateNewScheduledMessage', 'none');
}

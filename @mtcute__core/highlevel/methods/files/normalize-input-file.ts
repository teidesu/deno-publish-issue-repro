...
import type { InputFileLike } from "../../types/files/index.ts";
import { tdFileId } from '@mtcute/file-id';
import { tl } from '@mtcute/tl';
import { MtArgumentError } from "../../../types/errors.ts";
import { isUploadedFile } from "../../types/files/index.ts";
import { uploadFile } from "./upload-file.ts";
/**
 * Normalize a {@link InputFileLike} to `InputFile`,
 * uploading it if needed.
 */
export async function _normalizeInputFile(client: ITelegramClient, input: InputFileLike, params: {

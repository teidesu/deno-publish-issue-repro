...
import type { InputMediaLike, InputPeerLike, MessageMedia, RawDocument } from "../../types/index.ts";
 ...
 */
export async function uploadMedia(client: ITelegramClient, media: InputMediaLike, params: {
    /**

...
import type { InputFileLike, InputPeerLike, InputStickerSetItem, StickerType, } from "../../types/index.ts";
 ...
 */
export async function createStickerSet(client: ITelegramClient, params: {
    /**

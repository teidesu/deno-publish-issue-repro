...
import type { InputDocumentId, InputStickerSetItem } from "../../types/index.ts";
import { tdFileId } from '@mtcute/file-id';
import { StickerSet } from "../../types/index.ts";
import { fileIdToInputDocument } from "../../utils/convert-file-id.ts";
import { _normalizeInputStickerSetItem } from "./_utils.ts";
// @available=both
/**
 ...
 */
export async function replaceStickerInSet(client: ITelegramClient, sticker: InputDocumentId, newSticker: InputStickerSetItem, params?: {
    /**

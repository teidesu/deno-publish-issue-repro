...
import type { InputFileLike, InputStickerSet } from "../../types/index.ts";
 ...
 */
export async function setStickerSetThumb(client: ITelegramClient, id: InputStickerSet, thumb: InputFileLike | tl.TypeInputDocument, params?: {
    /**

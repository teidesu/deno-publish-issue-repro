...
import type { InputStickerSet, InputStickerSetItem, } from "../../types/index.ts";
 ...
 */
export async function addStickerToSet(client: ITelegramClient, setId: InputStickerSet, sticker: InputStickerSetItem, params?: {
    /**

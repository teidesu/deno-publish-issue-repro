...
import type { ChatInviteLinkMember, InputPeerLike } from "../../types/index.ts";
import { resolvePeer } from "../users/resolve-peer.ts";
import { getInviteLinkMembers } from "./get-invite-link-members.ts";
/**
 ...
 */
export async function* iterInviteLinkMembers(client: ITelegramClient, chatId: InputPeerLike, params?: Parameters<typeof getInviteLinkMembers>[2] & {
    /**

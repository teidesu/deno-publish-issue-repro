...
import type { ChatInviteLink, InputPeerLike } from "../../types/index.ts";
import { resolvePeer } from "../users/resolve-peer.ts";
import { getInviteLinks } from "./get-invite-links.ts";
/**
 ...
 * @param params
 */
export async function* iterInviteLinks(client: ITelegramClient, chatId: InputPeerLike, params?: Parameters<typeof getInviteLinks>[2] & {
    /**

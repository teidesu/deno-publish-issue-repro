...
import type { InputFileLike, InputMediaSticker } from "../../types/index.ts";
import { assertTrue, assertTypeIs } from "../../../utils/type-assertions.ts";
 ...
 */
export async function setBusinessIntro(client: ITelegramClient, intro: {
    /**

...
import type { InputPeerLike, StarsTransaction } from "../../types/index.ts";
import { resolvePeer } from "../users/resolve-peer.ts";
import { getStarsTransactions } from "./get-stars-transactions.ts";
/**
 ...
 */
export async function* iterStarsTransactions(client: ITelegramClient, peerId: InputPeerLike, params?: Parameters<typeof getStarsTransactions>[2] & {
    /**

...
import type { StarGift } from "../../types/premium/star-gift.ts";
 ...
 */
export async function sendStarGift(client: ITelegramClient, params: {
    ...
    const { peerId, gift, anonymous, message, shouldDispatch, withUpgrade, } = params;

 ...
 */
export async function getSavedStarGifts(client: ITelegramClient, params: {
    ...
    return makeArrayPaginated(res.gifts.map(it => new SavedStarGift(it, peers)), res.count, res.nextOffset);
}

...
import type { Boost } from "../../types/premium/boost.ts";
import { resolvePeer } from "../users/resolve-peer.ts";
import { getBoosts } from "./get-boosts.ts";
/**
 * Iterate over boosters of a channel.
 *
 * Wrapper over {@link getBoosters}
 */
export async function* iterBoosters(client: ITelegramClient, peerId: InputPeerLike, params?: Parameters<typeof getBoosts>[2] & {
    /**

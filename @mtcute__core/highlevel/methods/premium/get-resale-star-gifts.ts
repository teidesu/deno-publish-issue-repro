...
import type { ArrayPaginatedWithMeta } from "../../types/index.ts";
import { assert } from '@fuman/utils';
import Long from 'long';
import { LongMap } from "../../../utils/long-utils.ts";
import { PeersIndex, StarGiftUnique, StarGiftUniqueAttribute, StarGiftUniqueBackdrop } from "../../types/index.ts";
import { makeArrayPaginatedWithMeta } from "../../utils/misc-utils.ts";
// @exported
...
export function _normalizeResaleAttributes(attrs: tl.TypeStarGiftAttributeId[] | InputStarGiftAttributeIds): tl.TypeStarGiftAttributeId[] {
 ...
 */
export async function getStarGiftResaleOptions(client: ITelegramClient, params: {
    ...
    return makeArrayPaginatedWithMeta(res.gifts.map((it) => {

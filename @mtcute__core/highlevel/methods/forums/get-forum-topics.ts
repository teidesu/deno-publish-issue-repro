 ...
 */
export async function getForumTopics(client: ITelegramClient, chatId: InputPeerLike, params?: {
    /**
     * Search query
     */
    query?: string;
    ...
    if (!params)
        params = {};
    const { query, offset: { date: offsetDate, id: offsetId, topic: offsetTopic } = defaultOffset, limit = 100, } = params;

...
import { getForumTopics } from "./get-forum-topics.ts";
/**
 * Iterate over forum topics. Wrapper over {@link getForumTopics}.
 *
 * @param chatId  Chat ID or username
 */
export async function* iterForumTopics(client: ITelegramClient, chatId: InputPeerLike, params?: Parameters<typeof getForumTopics>[2] & {
    /**

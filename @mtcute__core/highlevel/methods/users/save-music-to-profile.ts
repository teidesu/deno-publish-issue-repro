...
import type { InputDocumentId, InputMediaAudio } from "../../types/index.ts";
...
export async function saveMusicToProfile(client: ITelegramClient, params: {
...
export async function unsaveMusicFromProfile(client: ITelegramClient, params: {

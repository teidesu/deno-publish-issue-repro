...
import { _handleContactsResolvedPeer } from "./resolve-peer.ts";
// @available=both
/**
 ...
 */
export async function resolvePhoneNumber(client: ITelegramClient, phone: string, force = false): Promise<tl.TypeInputPeer> {

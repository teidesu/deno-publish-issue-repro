...
import type { InputPeerLike, Photo } from "../../types/index.ts";
import { getProfilePhotos } from "./get-profile-photos.ts";
 ...
 * @param params
 */
export async function* iterProfilePhotos(client: ITelegramClient, userId: InputPeerLike, params?: Parameters<typeof getProfilePhotos>[2] & {
    /**

...
import { isInputPeerChannel, isInputPeerUser, normalizeDate, toInputChannel, toInputUser } from "../../utils/index.ts";
 ...
 */
export async function setEmojiStatus(client: ITelegramClient, params: {
    ...
    const { peerId, emoji, until, isCollectible, } = params;

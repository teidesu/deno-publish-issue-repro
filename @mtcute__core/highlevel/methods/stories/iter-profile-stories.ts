...
import type { InputPeerLike, Story } from "../../types/index.ts";
import { resolvePeer } from "../users/resolve-peer.ts";
import { getProfileStories } from "./get-profile-stories.ts";
/**
 * Iterate over profile stories. Wrapper over {@link getProfileStories}
 */
export async function* iterProfileStories(client: ITelegramClient, peerId: InputPeerLike, params?: Parameters<typeof getProfileStories>[2] & {
    /**

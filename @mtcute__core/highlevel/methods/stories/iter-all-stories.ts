...
import type { PeerStories } from "../../types/index.ts";
import { getAllStories } from "./get-all-stories.ts";
/**
 * Iterate over all stories (e.g. to load the top bar)
 *
 * Wrapper over {@link getAllStories}
 */
export async function* iterAllStories(client: ITelegramClient, params?: Parameters<typeof getAllStories>[1] & {
    /**

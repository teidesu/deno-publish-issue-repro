...
import type { InputPeerLike, StoryViewer } from "../../types/index.ts";
 ...
 */
export async function* iterStoryViewers(client: ITelegramClient, peerId: InputPeerLike, storyId: number, params?: Parameters<typeof getStoryViewers>[3] & {
    /**

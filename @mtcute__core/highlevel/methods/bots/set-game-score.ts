...
import type { InputMessageId, InputPeerLike, Message } from "../../types/index.ts";
 ...
 */
export async function setGameScore(client: ITelegramClient, params: InputMessageId & {
 ...
 * @param params
 */
export async function setInlineGameScore(client: ITelegramClient, params: {

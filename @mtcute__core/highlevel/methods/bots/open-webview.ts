...
import type { InputWebview } from "../../types/bots/webview.ts";
import type { InputPeerLike } from "../../types/index.ts";
import { asNonNull } from '@fuman/utils';
import Long from 'long';
import { assertNever } from "../../../types/utils.ts";
import { longToFastString } from "../../../utils/long-utils.ts";
import { WebviewResult } from "../../types/bots/webview.ts";
import { toInputPeer } from "../../utils/peer-utils.ts";
 ...
 * Open a webview.
 */
export async function openWebview(client: ITelegramClient, params: {
    ...
    const { webview, bot, chat, theme, platform, } = params;
 ...
 */
export async function closeWebview(client: ITelegramClient, webview: WebviewResult | tl.Long): Promise<void> {

...
import type { InputMessageId, InputPeerLike } from "../../types/index.ts";
import { GameHighScore, normalizeInputMessageId, PeersIndex } from "../../types/index.ts";
import { normalizeInlineId } from "../../utils/inline-utils.ts";
import { resolvePeer, resolveUser } from "../users/resolve-peer.ts";
/**
 * Get high scores of a game
 */
export async function getGameHighScores(client: ITelegramClient, params: InputMessageId & {
 ...
 */
export async function getInlineGameHighScores(client: ITelegramClient, messageId: string | tl.TypeInputBotInlineMessageID, userId?: InputPeerLike): Promise<GameHighScore[]> {

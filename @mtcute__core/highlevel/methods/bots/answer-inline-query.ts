...
import type { InputInlineResult } from "../../types/bots/index.ts";
import type { InlineQuery } from "../../types/updates/inline-query.ts";
import Long from 'long';
import { BotInline } from "../../types/bots/index.ts";
/**
 ...
 */
export async function answerInlineQuery(client: ITelegramClient, queryId: tl.Long | InlineQuery, results: InputInlineResult[], params?: {
    /**

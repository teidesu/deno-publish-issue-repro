...
import { Dialog } from "../../types/messages/dialog.ts";
 ...
 */
export async function getPeerDialogs(client: ITelegramClient, peers: MaybeArray<InputPeerLike>): Promise<(Dialog | null)[]> {

...
import type { RpcCallOptions } from "../network/index.ts";
import type { MaybeArray, MaybePromise, PartialExcept, PartialOnly } from "../types/index.ts";
import type { BaseTelegramClientOptions } from "./base.ts";
import type { ITelegramClient } from "./client.types.ts";
import type { LogOutResult } from "./methods/auth/log-out.ts";
import type { CreateGroupResult } from "./methods/chats/create-group.ts";
import type { GetForumTopicsOffset } from "./methods/forums/get-forum-topics.ts";
import type { GetInviteLinksOffset } from "./methods/invite-links/get-invite-links.ts";
import type { DeleteMessagesParams } from "./methods/messages/delete-messages.ts";
import type { ForwardMessageOptions } from "./methods/messages/forward-messages.ts";
import type { GetHistoryOffset } from "./methods/messages/get-history.ts";
import type { GetReactionUsersOffset } from "./methods/messages/get-reaction-users.ts";
import type { SearchGlobalOffset } from "./methods/messages/search-global.ts";
import type { SearchHashtagOffset } from "./methods/messages/search-hashtag.ts";
import type { SearchMessagesOffset } from "./methods/messages/search-messages.ts";
import type { SearchPostsGlobalOffset } from "./methods/messages/search-posts-global.ts";
import type { CommonSendParams } from "./methods/messages/send-common.ts";
import type { SendCopyGroupParams } from "./methods/messages/send-copy-group.ts";
import type { SendCopyParams } from "./methods/messages/send-copy.ts";
import type { QuoteParamsFrom } from "./methods/messages/send-quote.ts";
import type { CanApplyBoostResult } from "./methods/premium/can-apply-boost.ts";
import type { InputStarGiftAttributeIds, ResaleStarGiftsMeta } from "./methods/premium/get-resale-star-gifts.ts";
import type { CanSendStoryResult } from "./methods/stories/can-send-story.ts";
import type { ITelegramStorageProvider } from "./storage/provider.ts";
...
import type { ParsedUpdateHandlerParams } from "./updates/parsed.ts";
import type { RawUpdateInfo } from "./updates/types.ts";
import type { InputStringSessionData } from "./utils/string-session.ts";
/* THIS FILE WAS AUTO-GENERATED */
import { Emitter } from '@fuman/utils';
import { MtUnsupportedError } from "../types/index.ts";
import { BaseTelegramClient } from "./base.ts";
import { checkPassword } from "./methods/auth/check-password.ts";
import { getPasswordHint } from "./methods/auth/get-password-hint.ts";
import { logOut } from "./methods/auth/log-out.ts";
import { recoverPassword } from "./methods/auth/recover-password.ts";
import { resendCode } from "./methods/auth/resend-code.ts";
import { sendCode } from "./methods/auth/send-code.ts";
import { sendRecoveryCode } from "./methods/auth/send-recovery-code.ts";
import { signInBot } from "./methods/auth/sign-in-bot.ts";
import { signInQr } from "./methods/auth/sign-in-qr.ts";
import { signIn } from "./methods/auth/sign-in.ts";
import { startTest } from "./methods/auth/start-test.ts";
import { start } from "./methods/auth/start.ts";
import { isSelfPeer } from "./methods/auth/utils.ts";
import { answerCallbackQuery } from "./methods/bots/answer-callback-query.ts";
import { answerInlineQuery } from "./methods/bots/answer-inline-query.ts";
import { answerPreCheckoutQuery } from "./methods/bots/answer-pre-checkout-query.ts";
import { deleteMyCommands } from "./methods/bots/delete-my-commands.ts";
import { getBotInfo } from "./methods/bots/get-bot-info.ts";
import { getBotMenuButton } from "./methods/bots/get-bot-menu-button.ts";
import { getCallbackAnswer } from "./methods/bots/get-callback-answer.ts";
import { getGameHighScores, getInlineGameHighScores } from "./methods/bots/get-game-high-scores.ts";
import { getMyCommands } from "./methods/bots/get-my-commands.ts";
import { closeWebview, openWebview } from "./methods/bots/open-webview.ts";
import { prepareInlineMessage } from "./methods/bots/prepare-inline-message.ts";
import { setBotInfo } from "./methods/bots/set-bot-info.ts";
import { setBotMenuButton } from "./methods/bots/set-bot-menu-button.ts";
import { setGameScore, setInlineGameScore } from "./methods/bots/set-game-score.ts";
import { setMyCommands } from "./methods/bots/set-my-commands.ts";
import { setMyDefaultRights } from "./methods/bots/set-my-default-rights.ts";
import { toggleEmojiStatusPermission } from "./methods/bots/toggle-emoji-status-permission.ts";
import { addChatMembers } from "./methods/chats/add-chat-members.ts";
import { archiveChats } from "./methods/chats/archive-chats.ts";
import { banChatMember } from "./methods/chats/ban-chat-member.ts";
import { createChannel } from "./methods/chats/create-channel.ts";
import { createGroup } from "./methods/chats/create-group.ts";
import { createSupergroup } from "./methods/chats/create-supergroup.ts";
import { deleteChannel } from "./methods/chats/delete-channel.ts";
import { deleteChatPhoto } from "./methods/chats/delete-chat-photo.ts";
import { deleteGroup } from "./methods/chats/delete-group.ts";
import { deleteHistory } from "./methods/chats/delete-history.ts";
import { deleteUserHistory } from "./methods/chats/delete-user-history.ts";
import { editAdminRights } from "./methods/chats/edit-admin-rights.ts";
import { getChatEventLog } from "./methods/chats/get-chat-event-log.ts";
import { getChatMember } from "./methods/chats/get-chat-member.ts";
import { getChatMembers } from "./methods/chats/get-chat-members.ts";
import { getChatPreview } from "./methods/chats/get-chat-preview.ts";
import { getChat } from "./methods/chats/get-chat.ts";
import { getFullChat } from "./methods/chats/get-full-chat.ts";
import { getFullUser } from "./methods/chats/get-full-user.ts";
import { getMessageAuthor } from "./methods/chats/get-message-author.ts";
import { getNearbyChats } from "./methods/chats/get-nearby-chats.ts";
import { getPeer } from "./methods/chats/get-peer.ts";
import { getSimilarChannels } from "./methods/chats/get-similar-channels.ts";
import { getUser } from "./methods/chats/get-user.ts";
import { iterChatEventLog } from "./methods/chats/iter-chat-event-log.ts";
import { iterChatMembers } from "./methods/chats/iter-chat-members.ts";
import { joinChat } from "./methods/chats/join-chat.ts";
import { kickChatMember } from "./methods/chats/kick-chat-member.ts";
import { leaveChat } from "./methods/chats/leave-chat.ts";
import { markChatUnread } from "./methods/chats/mark-chat-unread.ts";
import { closeChat, openChat } from "./methods/chats/open-chat.ts";
import { reorderUsernames } from "./methods/chats/reorder-usernames.ts";
import { restrictChatMember } from "./methods/chats/restrict-chat-member.ts";
import { saveDraft } from "./methods/chats/save-draft.ts";
import { setChatColor } from "./methods/chats/set-chat-color.ts";
import { setChatDefaultPermissions } from "./methods/chats/set-chat-default-permissions.ts";
import { setChatDescription } from "./methods/chats/set-chat-description.ts";
import { setChatPhoto } from "./methods/chats/set-chat-photo.ts";
import { setChatTitle } from "./methods/chats/set-chat-title.ts";
import { setChatTtl } from "./methods/chats/set-chat-ttl.ts";
import { setChatUsername } from "./methods/chats/set-chat-username.ts";
import { setSlowMode } from "./methods/chats/set-slow-mode.ts";
import { toggleContentProtection } from "./methods/chats/toggle-content-protection.ts";
import { toggleFragmentUsername } from "./methods/chats/toggle-fragment-username.ts";
import { toggleJoinRequests } from "./methods/chats/toggle-join-requests.ts";
import { toggleJoinToSend } from "./methods/chats/toggle-join-to-send.ts";
import { unarchiveChats } from "./methods/chats/unarchive-chats.ts";
import { unbanChatMember } from "./methods/chats/unban-chat-member.ts";
import { addContact } from "./methods/contacts/add-contact.ts";
import { deleteContacts } from "./methods/contacts/delete-contacts.ts";
import { getContacts } from "./methods/contacts/get-contacts.ts";
import { importContacts } from "./methods/contacts/import-contacts.ts";
import { createFolder } from "./methods/dialogs/create-folder.ts";
import { deleteFolder } from "./methods/dialogs/delete-folder.ts";
import { editFolder } from "./methods/dialogs/edit-folder.ts";
import { findDialogs } from "./methods/dialogs/find-dialogs.ts";
import { findFolder } from "./methods/dialogs/find-folder.ts";
import { getChatlistPreview } from "./methods/dialogs/get-chatlist-preview.ts";
import { getFolders } from "./methods/dialogs/get-folders.ts";
import { getPeerDialogs } from "./methods/dialogs/get-peer-dialogs.ts";
import { iterDialogs } from "./methods/dialogs/iter-dialogs.ts";
import { joinChatlist } from "./methods/dialogs/join-chatlist.ts";
import { setFoldersOrder } from "./methods/dialogs/set-folders-order.ts";
import { downloadAsBuffer } from "./methods/files/download-buffer.ts";
import { downloadAsIterable } from "./methods/files/download-iterable.ts";
import { downloadAsStream } from "./methods/files/download-stream.ts";
import { _normalizeInputFile } from "./methods/files/normalize-input-file.ts";
import { _normalizeInputMedia } from "./methods/files/normalize-input-media.ts";
import { uploadFile } from "./methods/files/upload-file.ts";
import { uploadMedia } from "./methods/files/upload-media.ts";
import { createForumTopic } from "./methods/forums/create-forum-topic.ts";
import { deleteForumTopicHistory } from "./methods/forums/delete-forum-topic-history.ts";
import { editForumTopic } from "./methods/forums/edit-forum-topic.ts";
import { getForumTopicsById } from "./methods/forums/get-forum-topics-by-id.ts";
import { getForumTopics } from "./methods/forums/get-forum-topics.ts";
import { iterForumTopics } from "./methods/forums/iter-forum-topics.ts";
import { reorderPinnedForumTopics } from "./methods/forums/reorder-pinned-forum-topics.ts";
import { toggleForumTopicClosed } from "./methods/forums/toggle-forum-topic-closed.ts";
import { toggleForumTopicPinned } from "./methods/forums/toggle-forum-topic-pinned.ts";
import { updateForumSettings } from "./methods/forums/toggle-forum.ts";
import { toggleGeneralTopicHidden } from "./methods/forums/toggle-general-topic-hidden.ts";
import { createInviteLink } from "./methods/invite-links/create-invite-link.ts";
import { editInviteLink } from "./methods/invite-links/edit-invite-link.ts";
import { exportInviteLink } from "./methods/invite-links/export-invite-link.ts";
import { getInviteLinkMembers } from "./methods/invite-links/get-invite-link-members.ts";
import { getInviteLink } from "./methods/invite-links/get-invite-link.ts";
import { getInviteLinks } from "./methods/invite-links/get-invite-links.ts";
import { getPrimaryInviteLink } from "./methods/invite-links/get-primary-invite-link.ts";
import { hideAllJoinRequests } from "./methods/invite-links/hide-all-join-requests.ts";
import { hideJoinRequest } from "./methods/invite-links/hide-join-request.ts";
import { iterInviteLinkMembers } from "./methods/invite-links/iter-invite-link-members.ts";
import { iterInviteLinks } from "./methods/invite-links/iter-invite-links.ts";
import { revokeInviteLink } from "./methods/invite-links/revoke-invite-link.ts";
import { appendTodoList } from "./methods/messages/append-todo-list.ts";
import { closePoll } from "./methods/messages/close-poll.ts";
import { deleteMessages, deleteMessagesById } from "./methods/messages/delete-messages.ts";
import { deleteScheduledMessages } from "./methods/messages/delete-scheduled-messages.ts";
import { editInlineMessage } from "./methods/messages/edit-inline-message.ts";
import { editMessage } from "./methods/messages/edit-message.ts";
import { forwardMessages, forwardMessagesById } from "./methods/messages/forward-messages.ts";
import { getAllScheduledMessages } from "./methods/messages/get-all-scheduled-messages.ts";
import { getAvailableMessageEffects } from "./methods/messages/get-available-effects.ts";
import { getCallbackQueryMessage } from "./methods/messages/get-callback-query-message.ts";
import { getDiscussionMessage } from "./methods/messages/get-discussion-message.ts";
import { getFactCheck } from "./methods/messages/get-fact-check.ts";
import { getHistory } from "./methods/messages/get-history.ts";
import { getMessageByLink } from "./methods/messages/get-message-by-link.ts";
import { getMessageGroup } from "./methods/messages/get-message-group.ts";
import { getMessageReactions, getMessageReactionsById } from "./methods/messages/get-message-reactions.ts";
import { getMessagesUnsafe } from "./methods/messages/get-messages-unsafe.ts";
import { getMessages } from "./methods/messages/get-messages.ts";
import { getReactionUsers } from "./methods/messages/get-reaction-users.ts";
import { getReplyTo } from "./methods/messages/get-reply-to.ts";
import { getScheduledMessages } from "./methods/messages/get-scheduled-messages.ts";
import { getWebPagePreview } from "./methods/messages/get-web-page-preview.ts";
import { iterHistory } from "./methods/messages/iter-history.ts";
import { iterReactionUsers } from "./methods/messages/iter-reaction-users.ts";
import { iterSearchGlobal } from "./methods/messages/iter-search-global.ts";
import { iterSearchMessages } from "./methods/messages/iter-search-messages.ts";
import { pinMessage } from "./methods/messages/pin-message.ts";
import { readHistory } from "./methods/messages/read-history.ts";
import { readReactions } from "./methods/messages/read-reactions.ts";
import { searchGlobal } from "./methods/messages/search-global.ts";
import { iterSearchHashtag, searchHashtag } from "./methods/messages/search-hashtag.ts";
import { searchMessages } from "./methods/messages/search-messages.ts";
import { searchPostsGlobal } from "./methods/messages/search-posts-global.ts";
import { answerMedia, answerMediaGroup, answerText } from "./methods/messages/send-answer.ts";
import { commentMedia, commentMediaGroup, commentText } from "./methods/messages/send-comment.ts";
import { sendCopyGroup } from "./methods/messages/send-copy-group.ts";
import { sendCopy } from "./methods/messages/send-copy.ts";
import { sendMediaGroup } from "./methods/messages/send-media-group.ts";
import { sendMedia } from "./methods/messages/send-media.ts";
import { sendPaidReaction } from "./methods/messages/send-paid-reaction.ts";
import { quoteWithMedia, quoteWithMediaGroup, quoteWithText } from "./methods/messages/send-quote.ts";
import { sendReaction } from "./methods/messages/send-reaction.ts";
import { replyMedia, replyMediaGroup, replyText } from "./methods/messages/send-reply.ts";
import { sendScheduled } from "./methods/messages/send-scheduled.ts";
import { sendText } from "./methods/messages/send-text.ts";
import { sendTyping } from "./methods/messages/send-typing.ts";
import { sendVote } from "./methods/messages/send-vote.ts";
import { setTyping } from "./methods/messages/set-typing.ts";
import { toggleTodoCompleted } from "./methods/messages/toggle-todo-completed.ts";
import { translateMessage } from "./methods/messages/translate-message.ts";
import { translateText } from "./methods/messages/translate-text.ts";
import { unpinAllMessages } from "./methods/messages/unpin-all-messages.ts";
import { unpinMessage } from "./methods/messages/unpin-message.ts";
import { getCollectibleInfo } from "./methods/misc/get-collectible-info.ts";
import { initTakeoutSession } from "./methods/misc/init-takeout-session.ts";
import { _normalizePrivacyRules } from "./methods/misc/normalize-privacy-rules.ts";
import { withParams } from "./methods/misc/with-params.ts";
import { changeCloudPassword } from "./methods/password/change-cloud-password.ts";
import { enableCloudPassword } from "./methods/password/enable-cloud-password.ts";
import { cancelPasswordEmail, resendPasswordEmail, verifyPasswordEmail } from "./methods/password/password-email.ts";
import { removeCloudPassword } from "./methods/password/remove-cloud-password.ts";
import { _normalizeInputStarGift } from "./methods/premium/_normalize-input-star-gift.ts";
import { acceptStarGift } from "./methods/premium/accept-star-gift.ts";
import { applyBoost } from "./methods/premium/apply-boost.ts";
import { buyResaleGift } from "./methods/premium/buy-resale-gift.ts";
import { canApplyBoost } from "./methods/premium/can-apply-boost.ts";
import { createBusinessChatLink } from "./methods/premium/create-business-chat-link.ts";
import { deleteBusinessChatLink, editBusinessChatLink } from "./methods/premium/edit-business-chat-link.ts";
import { getBoostStats } from "./methods/premium/get-boost-stats.ts";
import { getBoosts } from "./methods/premium/get-boosts.ts";
import { getBusinessChatLinks } from "./methods/premium/get-business-chat-links.ts";
import { getBusinessConnection } from "./methods/premium/get-business-connection.ts";
import { getMyBoostSlots } from "./methods/premium/get-my-boost-slots.ts";
import { getStarGiftResaleOptions } from "./methods/premium/get-resale-star-gifts.ts";
import { getSavedStarGiftsById } from "./methods/premium/get-saved-star-gifts-by-id.ts";
import { getSavedStarGifts } from "./methods/premium/get-saved-star-gifts.ts";
import { getStarGiftOptions } from "./methods/premium/get-star-gift-options.ts";
import { getStarGiftValue } from "./methods/premium/get-star-gift-value.ts";
import { getStarGiftWithdrawalUrl } from "./methods/premium/get-star-gift-withdrawal-url.ts";
import { getStarsTransactions } from "./methods/premium/get-stars-transactions.ts";
import { getUniqueStarGift } from "./methods/premium/get-unique-star-gift.ts";
import { iterBoosters } from "./methods/premium/iter-boosters.ts";
import { iterSavedStarGifts } from "./methods/premium/iter-saved-star-gifts.ts";
import { iterStarsTransactions } from "./methods/premium/iter-stars-transactions.ts";
import { togglePinnedStarGifts } from "./methods/premium/pin-star-gift.ts";
import { prepayStarGiftUpgrade } from "./methods/premium/prepay-star-gift-upgrade.ts";
import { sendStarGift } from "./methods/premium/send-star-gift.ts";
import { setBusinessIntro } from "./methods/premium/set-business-intro.ts";
import { setBusinessWorkHours } from "./methods/premium/set-business-work-hours.ts";
import { setResaleStarGiftPrice } from "./methods/premium/set-gift-resale-price.ts";
import { transferStarGift } from "./methods/premium/transfer-star-gift.ts";
import { upgradeStarGift } from "./methods/premium/upgrade-star-gift.ts";
import { addStickerToSet } from "./methods/stickers/add-sticker-to-set.ts";
import { createStickerSet } from "./methods/stickers/create-sticker-set.ts";
import { deleteStickerFromSet } from "./methods/stickers/delete-sticker-from-set.ts";
import { getCustomEmojis, getCustomEmojisFromMessages } from "./methods/stickers/get-custom-emojis.ts";
import { getInstalledStickers } from "./methods/stickers/get-installed-stickers.ts";
import { getMyStickerSets } from "./methods/stickers/get-my-sticker-sets.ts";
import { getStickerSet } from "./methods/stickers/get-sticker-set.ts";
import { moveStickerInSet } from "./methods/stickers/move-sticker-in-set.ts";
import { replaceStickerInSet } from "./methods/stickers/replace-sticker-in-set.ts";
import { setChatStickerSet } from "./methods/stickers/set-chat-sticker-set.ts";
import { setStickerSetThumb } from "./methods/stickers/set-sticker-set-thumb.ts";
import { canSendStory } from "./methods/stories/can-send-story.ts";
import { deleteStories } from "./methods/stories/delete-stories.ts";
import { editStory } from "./methods/stories/edit-story.ts";
import { getAllStories } from "./methods/stories/get-all-stories.ts";
import { getPeerStories } from "./methods/stories/get-peer-stories.ts";
import { getProfileStories } from "./methods/stories/get-profile-stories.ts";
import { getStoriesById } from "./methods/stories/get-stories-by-id.ts";
import { getStoriesInteractions } from "./methods/stories/get-stories-interactions.ts";
import { getStoryLink } from "./methods/stories/get-story-link.ts";
import { getStoryViewers } from "./methods/stories/get-story-viewers.ts";
import { hideMyStoriesViews } from "./methods/stories/hide-my-stories-views.ts";
import { incrementStoriesViews } from "./methods/stories/increment-stories-views.ts";
import { iterAllStories } from "./methods/stories/iter-all-stories.ts";
import { iterProfileStories } from "./methods/stories/iter-profile-stories.ts";
import { iterStoryViewers } from "./methods/stories/iter-story-viewers.ts";
import { readStories } from "./methods/stories/read-stories.ts";
import { sendStoryReaction } from "./methods/stories/send-story-reaction.ts";
import { sendStory } from "./methods/stories/send-story.ts";
import { togglePeerStoriesArchived } from "./methods/stories/toggle-peer-stories-archived.ts";
import { toggleStoriesPinned } from "./methods/stories/toggle-stories-pinned.ts";
import { blockUser } from "./methods/users/block-user.ts";
import { deleteProfilePhotos } from "./methods/users/delete-profile-photos.ts";
import { editCloseFriends, editCloseFriendsRaw } from "./methods/users/edit-close-friends.ts";
import { getCommonChats } from "./methods/users/get-common-chats.ts";
import { getGlobalTtl } from "./methods/users/get-global-ttl.ts";
import { getMe } from "./methods/users/get-me.ts";
import { getMyUsername } from "./methods/users/get-my-username.ts";
import { getPeerSettings } from "./methods/users/get-peer-settings.ts";
import { getProfilePhoto } from "./methods/users/get-profile-photo.ts";
import { getProfilePhotos } from "./methods/users/get-profile-photos.ts";
import { getSavedMusic } from "./methods/users/get-saved-music.ts";
import { getUsers } from "./methods/users/get-users.ts";
import { isPeerAvailable } from "./methods/users/is-peer-available.ts";
import { iterProfilePhotos } from "./methods/users/iter-profile-photos.ts";
import { resolvePeerMany } from "./methods/users/resolve-peer-many.ts";
import { resolveChannel, resolvePeer, resolveUser } from "./methods/users/resolve-peer.ts";
import { resolvePhoneNumber } from "./methods/users/resolve-phone-number.ts";
import { saveMusicToProfile, unsaveMusicFromProfile } from "./methods/users/save-music-to-profile.ts";
import { setEmojiStatus } from "./methods/users/set-emoji-status.ts";
import { setGlobalTtl } from "./methods/users/set-global-ttl.ts";
import { setMyBirthday } from "./methods/users/set-my-birthday.ts";
import { setMyProfilePhoto } from "./methods/users/set-my-profile-photo.ts";
import { setMyUsername } from "./methods/users/set-my-username.ts";
import { sendOnline, setOnline } from "./methods/users/set-online.ts";
import { unblockUser } from "./methods/users/unblock-user.ts";
import { updateProfile } from "./methods/users/update-profile.ts";
import { Conversation } from "./types/conversation.ts";
import { makeParsedUpdateHandler } from "./updates/parsed.ts";
// from methods/_init.ts
// @copy
type TelegramClientOptions = ((PartialOnly<Omit<BaseTelegramClientOptions, 'storage'>, 'transport' | 'crypto' | 'platform'> & {
    /**
...
export interface TelegramClient extends ITelegramClient {
     ...
     */
    answerCallbackQuery(queryId: Long | CallbackQuery, params?: {
        /**
     ...
     * @param params  Additional parameters
     */
    answerInlineQuery(queryId: tl.Long | InlineQuery, results: InputInlineResult[], params?: {
        /**
     ...
     */
    answerPreCheckoutQuery(queryId: tl.Long | PreCheckoutQuery, params?: {
     ...
     */
    getInlineGameHighScores(messageId: string | tl.TypeInputBotInlineMessageID, userId?: InputPeerLike): Promise<GameHighScore[]>;
    /**
     ...
     */
    closeWebview(webview: WebviewResult | tl.Long): Promise<void>;
    /**
     ...
     */
    setGameScore(params: InputMessageId & {
     ...
     *
     */
    toggleEmojiStatusPermission(params: {
     ...
     * @param params
     */
    getChatEventLog(chatId: InputPeerLike, params?: {
        /**
         * Search query
         */
        query?: string;
     ...
     * @param params  Additional parameters
     */
    getChatMembers(chatId: InputPeerLike, params?: {
        /**
     ...
     * @param params
     */
    iterChatEventLog(chatId: InputPeerLike, params?: Parameters<typeof getChatEventLog>[2] & {
        /**
     ...
     * @param params  Additional parameters
     */
    iterChatMembers(chatId: InputPeerLike, params?: Parameters<typeof getChatMembers>[2] & {
        /**
     ...
     * @param chatId  Chat ID or username
     */
    leaveChat(chatId: InputPeerLike, params?: {
        /**
     ...
     *     and passing `{}` (empty object) will lift any restrictions
     */
    setChatDefaultPermissions(chatId: InputPeerLike, restrictions: Omit<tl.RawChatBannedRights, '_' | 'untilDate'>): Promise<Chat>;
    /**
     ...
     */
    joinChatlist(link: string, params?: {
     ...
     * @param [params={}]  Upload parameters
     */
    uploadMedia(media: InputMediaLike, params?: {
        peer?: InputPeerLike;
        progressCallback?: (uploaded: number, total: number) => void;
     ...
     * @param chatId  Chat ID or username
     */
    iterForumTopics(chatId: InputPeerLike, params?: Parameters<typeof getForumTopics>[2] & {
        /**
         * Maximum number of topics to return.
         *
     ...
     * @param params  Additional params
     */
    iterInviteLinkMembers(chatId: InputPeerLike, params?: Parameters<typeof getInviteLinkMembers>[2] & {
        /**
         * Maximum number of users to return
         *
     ...
     * @param params
     */
    iterInviteLinks(chatId: InputPeerLike, params?: Parameters<typeof getInviteLinks>[2] & {
        /**
         * Limit the number of invite links to be fetched.
     ...
     * @param params
     */
    editMessage(params: InputMessageId & {
        /**
         * New message text
         *
         * When `media` is passed, `media.caption` is used instead
     ...
     */
    forwardMessagesById(params: ForwardMessageOptions & {
     ...
     *
     */
    forwardMessages(params: ForwardMessageOptions & {
        messages: Message[];
    }): Promise<Message[]>;
    /**
     ...
     *
     */
    getCallbackQueryMessage(id: CallbackQuery | tl.RawUpdateBotCallbackQuery | {
        messageId: number;
        queryId: tl.Long;
        peer: InputPeerLike;
    }): Promise<Message | null>;
     ...
     */
    getHistory(chatId: InputPeerLike, params?: {
        /**
     ...
     * @param params
     */
    getReactionUsers(params: InputMessageId & {
        /**
     ...
     * @param params  Additional fetch parameters
     */
    iterHistory(chatId: InputPeerLike, params?: Parameters<typeof getHistory>[2] & {
        /**
         * Limits the number of messages to be retrieved.
         *
     ...
     * @param params
     */
    iterReactionUsers(params: Parameters<typeof getReactionUsers>[1] & {
        /**
         * Limit the number of events returned.
         *
     ...
     */
    iterSearchGlobal(params?: Parameters<typeof searchGlobal>[1] & {
        /**
         * Limits the number of messages to be retrieved.
         *
     ...
     */
    iterSearchMessages(params?: Parameters<typeof searchMessages>[1] & {
        /**
         * Limits the number of messages to be retrieved.
         *
         * @default  `Infinity`, i.e. all messages are returned
     ...
     */
    pinMessage(params: InputMessageId & {
     ...
     * @param chatId  Chat ID
     */
    readHistory(chatId: InputPeerLike, params?: {
        /**
     ...
     * @param chatId  Chat ID
     */
    readReactions(chatId: InputPeerLike, params?: {
        /**
         * Whether to dispatch updates that will be generated by this call.
         * Doesn't follow `disableNoDispatch`
         */
    ...
    answerMediaGroup(message: Message, ...params: ParametersSkip2<typeof sendMediaGroup>): ReturnType<typeof sendMediaGroup>;
    /**
     ...
     *     To check if a post has comments, use {@link Message#replies}.hasComments
     */
    commentMediaGroup(message: Message, ...params: ParametersSkip2<typeof sendMediaGroup>): ReturnType<typeof sendMediaGroup>;
    /**
     ...
     *
     */
    sendCopyGroup(params: SendCopyGroupParams & ({
        /** Source chat ID */
        fromChatId: InputPeerLike;
        /** Message IDs to forward */
        messages: number[];
     ...
     *
     */
    sendCopy(params: SendCopyParams & ({
        /** Source chat ID */
        fromChatId: InputPeerLike;
     ...
     * @link InputMedia
     */
    sendMediaGroup(chatId: InputPeerLike, medias: (InputMediaLike | string)[], params?: CommonSendParams & {
        /**
         * Whether to invert media position.
         *
         * Currently only supported for web previews and makes the
    ...
    quoteWithText(message: Message, params: QuoteParamsFrom<Parameters<typeof sendText>[3]> & {
        /** Text to send */
        text: Parameters<typeof sendText>[2];
    }): ReturnType<typeof sendText>;
    /** Send a media in reply to a given quote */
    quoteWithMedia(message: Message, params: QuoteParamsFrom<Parameters<typeof sendMedia>[3]> & {
        /** Media to send */
        media: Parameters<typeof sendMedia>[2];
    }): ReturnType<typeof sendMedia>;
    /** Send a media group in reply to a given quote */
    quoteWithMediaGroup(message: Message, params: QuoteParamsFrom<Parameters<typeof sendMediaGroup>[3]> & {
        /** Media group to send */
     ...
     *   The message is normally available for users, but may not be available for bots in PMs.
     */
    sendReaction(params: InputMessageId & {
     ...
     *
     */
    sendVote(params: InputMessageId & {
        /**
     ...
     *
     */
    translateMessage(params: InputMessageId & {
     ...
     */
    unpinAllMessages(chatId: InputPeerLike, params?: {
        /**
     ...
     */
    createBusinessChatLink(text: InputText, params?: {
     ...
     */
    editBusinessChatLink(link: string | BusinessChatLink, params: {
     ...
     *
     */
    getBoosts(peerId: InputPeerLike, params?: {
        /**
         * Offset for pagination
         */
        offset?: string;
     ...
     * @param params  Additional parameters
     */
    getStarsTransactions(peerId: InputPeerLike, params?: {
        /**
     ...
     * @param params  Additional parameters
     */
    iterStarsTransactions(peerId: InputPeerLike, params?: Parameters<typeof getStarsTransactions>[2] & {
        /**
         * Total number of boosters to fetch
         *
         * @default  Infinity, i.e. fetch all boosters
     ...
     */
    addStickerToSet(setId: InputStickerSet, sticker: InputStickerSetItem, params?: {
        /**
     ...
     * @returns  Modified sticker set
     */
    setStickerSetThumb(id: InputStickerSet, thumb: InputFileLike | tl.TypeInputDocument, params?: {
        /**
         * Upload progress callback
         *
         * @param uploaded  Number of bytes uploaded
     ...
     *
     */
    getProfileStories(peerId: InputPeerLike, params?: {
        /**
     ...
     *
     */
    getStoryViewers(peerId: InputPeerLike, storyId: number, params?: {
        /**
     ...
     * @param params
     */
    getProfilePhotos(userId: InputPeerLike, params?: {
        /**
     ...
     * @param params
     */
    iterProfilePhotos(userId: InputPeerLike, params?: Parameters<typeof getProfilePhotos>[2] & {
        /**
     ...
     */
    resolvePeerMany<T extends tl.TypeInputPeer | tl.TypeInputUser | tl.TypeInputChannel>(peerIds: InputPeerLike[], normalizer: (obj: tl.TypeInputPeer) => T | null): Promise<T[]>;
    /**
     * Get multiple `InputPeer`s at once.
     *
    ...
    constructor(opts: TelegramClientOptions) {
        ...
        if ('client' in opts) {
            ...
            if (!opts.storage || typeof opts.storage === 'string' || !opts.transport || !opts.crypto || !opts.platform) {
                throw new MtUnsupportedError('You need to explicitly provide storage, transport, crypto and platform for @mtcute/core');
            }
        ...
        if (!opts.disableUpdates) {
            ...
            this._client.onRawUpdate.add(makeParsedUpdateHandler({

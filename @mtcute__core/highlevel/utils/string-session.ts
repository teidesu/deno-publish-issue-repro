import type { DcOptions } from "../../utils/dcs.ts";
import type { CurrentUserInfo } from "../storage/service/current-user.ts";
import { base64 } from '@fuman/utils';
import { TlBinaryReader, TlBinaryWriter } from '@mtcute/tl-runtime';
import { MtArgumentError } from "../../types/index.ts";
import { defaultProductionDc, defaultTestDc, parseBasicDcOption, serializeBasicDcOption } from "../../utils/dcs.ts";

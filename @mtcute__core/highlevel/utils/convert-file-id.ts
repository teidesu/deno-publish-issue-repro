...
import { parseMarkedPeerId } from "../../utils/peer-utils.ts";
import FileType = td.FileType;
const EMPTY_BUFFER = new Uint8Array(0);
type FileId = td.RawFullRemoteFileLocation;
function dialogPhotoToInputPeer(dialog: td.RawPhotoSizeSourceDialogPhoto | td.RawPhotoSizeSourceDialogPhotoLegacy): tl.TypeInputPeer {
        ...
        case 'photo': {
            switch (loc.source._) {
                ...
                case 'thumbnail':
                    ...
                    return {
                        _: loc.source.fileType === FileType.Photo

...
import type { ServiceOptions } from "../../service/base.ts";
import type { BaseSqliteStorageDriver } from "../driver.ts";
import type { ISqliteStatement } from "../types.ts";
import { __tlReaderMap } from '@mtcute/tl/binary/reader.js';
import { __tlWriterMap } from '@mtcute/tl/binary/writer.js';
import { CurrentUserService } from "../../../highlevel/storage/service/current-user.ts";
import { UpdatesStateService } from "../../../highlevel/storage/service/updates.ts";
import { DefaultDcsService } from "../../service/default-dcs.ts";
...
export class SqliteKeyValueRepository implements IKeyValueRepository {
    constructor(readonly _driver: BaseSqliteStorageDriver) {
        ...
        _driver.registerLegacyMigration('kv', (db) => {
            ...
            const all = db.prepare('select key, value from kv').all() as {
                key: string;
                value: string;
            }[];

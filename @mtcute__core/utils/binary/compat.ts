...
import { PeersIndex } from "../../highlevel/types/peers/peers-index.ts";
function replaceType<Input extends tlCompat.TlObject, NewTypeName extends tl.TlObject['_']>(obj: Input, type: NewTypeName): Omit<Input, '_'> & {
    _: NewTypeName;
} {
...
function dropFields<T extends tlCompat.TlObject, const Fields extends (keyof T)[]>(obj: T, fields: Fields): Omit<T, Fields[number]> {

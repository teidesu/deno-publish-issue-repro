...
import type { BasicPeerType } from "../types/peers.ts";
...
export function getMarkedPeerId(peer: tl.TypePeer | tl.TypeInputPeer | tl.TypeInputUser | tl.TypeInputChannel | number, peerType?: BasicPeerType): number {
 ...
 */
export function parseMarkedPeerId(id: number): [
    BasicPeerType,
    number
] {
    if (id < 0) {
...
export function getBasicPeerType(id: number | tl.TypePeer | tl.TypeInputPeer | tl.TypeInputUser | tl.TypeInputChannel): BasicPeerType {

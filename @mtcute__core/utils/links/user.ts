import type { Deeplink } from "./common.ts";
import { deeplinkBuilder } from "./common.ts";
/**
 * Public username links
 *
 * Used to link to public users, groups and channels
 */
export const publicUsername: Deeplink<{
    username: string;
 ...
 */
export const temporaryProfile: Deeplink<{
    token: string;
}> = /* #__PURE__ */ deeplinkBuilder({
 ...
 */
export const phoneNumber: Deeplink<{
    phone: string;
}> = /* #__PURE__ */ deeplinkBuilder({

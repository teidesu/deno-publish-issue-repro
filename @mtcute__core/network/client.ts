...
import type { MustEqual } from "../types/index.ts";
import type { ICorePlatform } from "../types/platform.ts";
import type { DcOptions, ICryptoProvider, Logger, } from "../utils/index.ts";
import type { NetworkManagerExtraParams, RpcCallOptions } from "./network-manager.ts";
...
import { asyncResettable, defaultProductionDc, defaultProductionIpv6Dc, defaultTestDc, defaultTestIpv6Dc, isTlRpcError, LogManager, } from "../utils/index.ts";
...
export class MtClient {
     ...
     */
    async call<T extends tl.RpcMethod>(message: MustEqual<T, tl.RpcMethod>, params?: RpcCallOptions): Promise<tl.RpcCallReturn[T['_']] | mtp.RawMt_rpc_error> {

...
import type { ICryptoProvider } from "../../utils/crypto/abstract.ts";
import type { Logger } from "../../utils/logger.ts";
import type { IPacketCodec } from "../transports/index.ts";
...
class TlsHelloWriter {
    ...
    constructor(readonly crypto: ICryptoProvider, size: number, domain: Uint8Array) {
        this._domain = domain;
...
export async function generateFakeTlsHeader(domain: Uint8Array, secret: Uint8Array, crypto: ICryptoProvider): Promise<Uint8Array> {

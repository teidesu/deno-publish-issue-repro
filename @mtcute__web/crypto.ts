...
import type { WasmInitInput } from "./wasm.ts";
...
import { loadWasmBinary } from "./wasm.ts";
...
export class WebCryptoProvider extends BaseCryptoProvider implements ICryptoProvider {
    ...
    async pbkdf2(password: Uint8Array, salt: Uint8Array, iterations: number, keylen?: number | undefined, algo?: string | undefined): Promise<Uint8Array> {
    ...
    async hmacSha256(data: Uint8Array, key: Uint8Array): Promise<Uint8Array> {
        const keyMaterial = await this.crypto.subtle.importKey('raw', key as Uint8Array<ArrayBuffer>, { name: 'HMAC', hash: { name: 'SHA-256' } }, false, ['sign']);

 ...
 */
export class ChatJoinRequestUpdateContext extends BotChatJoinRequestUpdate implements UpdateContext<BotChatJoinRequestUpdate> {
    readonly _name = 'bot_chat_join_request' as const;
    constructor(readonly client: TelegramClient, update: BotChatJoinRequestUpdate) {

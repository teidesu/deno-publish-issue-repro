import type { UpdateContextType } from "./parse.ts";
...
import { CallbackQueryContext, InlineCallbackQueryContext } from "./callback-query.ts";
...
export class SceneTransitionContext {
    ...
    get inlineCallbackQuery(): InlineCallbackQueryContext {
        ...
        throw new MtTypeAssertionError('SceneTransitionContext.inlineCallbackQuery', 'inline callback query', this.update._name);
    }
}

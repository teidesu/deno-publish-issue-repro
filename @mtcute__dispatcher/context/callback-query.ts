...
import type { UpdateContext } from "./base.ts";
...
export class CallbackQueryContext extends CallbackQuery implements UpdateContext<CallbackQuery> {
    ...
    constructor(readonly client: TelegramClient, query: CallbackQuery) {
     ...
     */
    async editMessageWith(handler: (msg: Message) => MaybePromise<Parameters<CallbackQueryContext['editMessage']>[0]>): Promise<Message | undefined> {
...
export class InlineCallbackQueryContext extends InlineCallbackQuery implements UpdateContext<InlineCallbackQuery> {
    ...
    constructor(readonly client: TelegramClient, query: InlineCallbackQuery) {
        super(query.raw, query._peers);
    }
    /** Answer to this callback query */
    answer(params: Parameters<TelegramClient['answerCallbackQuery']>[1]): Promise<void> {
 ...
 */
export class BusinessCallbackQueryContext extends BusinessCallbackQuery implements UpdateContext<BusinessCallbackQuery> {
    readonly _name = 'business_callback_query' as const;
    constructor(readonly client: TelegramClient, query: BusinessCallbackQuery) {
        super(query.raw, query._peers);
    }
    /** Answer to this callback query */
    answer(params: Parameters<TelegramClient['answerCallbackQuery']>[1]): Promise<void> {

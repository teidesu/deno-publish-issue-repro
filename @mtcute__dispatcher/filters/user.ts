 ...
 */
export const me: UpdateFilter<Message, {
    sender: User;
}> = msg => (msg.sender.type === 'user' && msg.sender.isSelf) || msg.isOutgoing;
/**
 * Filter messages sent by bots
 */
export const bot: UpdateFilter<Message, {
    sender: User;
}> = msg => msg.sender.constructor === User && msg.sender.isBot;
/**

import type { BusinessCallbackQuery, CallbackQuery, ChosenInlineResult, InlineCallbackQuery, InlineQuery, } from '@mtcute/core';
import type { UpdateContextDistributed } from "../context/base.ts";
import type { UpdateFilter } from "./types.ts";
import { BusinessMessage, Message, } from '@mtcute/core';
 ...
 */
export function regex(regex: RegExp): UpdateFilter<UpdatesWithText, {

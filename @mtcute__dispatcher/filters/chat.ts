import type { BotChatJoinRequestUpdate, BusinessMessage, Chat, ChatMemberUpdate, ChatType, DeleteBusinessMessageUpdate, HistoryReadUpdate, MaybeArray, Message, Peer, PollVoteUpdate, User, UserTypingUpdate, } from '@mtcute/core';
import type { UpdateContextDistributed } from "../context/base.ts";
import type { EmptyObject, Modify, UpdateFilter } from "./types.ts";
/**
 * Filter updates by type of the chat where they happened
 */
export function chat<T extends ChatType | 'user', Obj extends {
    chat: Peer;

import type { TlErrors } from "../types.ts";
...
function parseCode(err: string, placeholders_?: string[]): [
    string,
    string[]
] {
 ...
 */
export function generateCodeForErrors(errors: TlErrors, exports = 'exports.'): [
    string,
    string
] {

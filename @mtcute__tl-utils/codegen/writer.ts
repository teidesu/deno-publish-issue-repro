...
import { calculateStaticSizes } from "../calculator.ts";
...
const TL_WRITER_PRELUDE = 'function h(o,p){'
    + 'var q=o[p];'
    + 'if(q===void 0)'
 ...
 */
export function generateWriterCodeForTlEntries(entries: TlEntry[], params: WriterCodegenOptions = DEFAULT_OPTIONS): string {
